...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('users', '0002_classes_contact_alter_user_options_and_more'),
    ]

    operations = [
        migrations.AlterModelOptions(
            name='staff',
            options={'ordering': ['-trainer_name'], 'verbose_name_plural': 'Staff'},
        ),
        migrations.AlterModelOptions(
            name='subscription',
            options={'ordering': ['-subscription_name', '-billing_duration'], 'verbose_name_plural': 'Subscription'},
        ),
